                    ...
                    <table className="min-w-full text-sm text-left text-gray-500 bg-white border-collapse">
                        <thead className="text-xs uppercase bg-blue-800 text-white">
                            <tr>
                                ...
                                <th scope="col" className="px-6 py-3">ENTRYCODE</th>
                                <th scope="col" className="px-6 py-3">LINKTRY</th>
                                <th scope="col" className="px-6 py-3">CATCODE</th>
                                <th scope="col" className="px-6 py-3">STYPE</th>
                                <th scope="col" className="px-6 py-3">BUILTUP</th>
                                <th scope="col" className="px-6 py-3">CARPET</th>
                                <th scope="col" className="px-6 py-3">RATEBUY</th>
                                <th scope="col" className="px-6 py-3">RATELEASE</th>
                                <th scope="col" className="px-6 py-3">BUCRATIO</th>
                                <th scope="col" className="px-6 py-3">FLOOR</th>
                                <th scope="col" className="px-6 py-3">REMARKS</th>
                                <th scope="col" className="px-6 py-3">USERID</th>
                                <th scope="col" className="px-6 py-3">EDITDATE</th>
                                <th scope="col" className="px-6 py-3">WING</th>
                                <th scope="col" className="px-6 py-3">CARPARKIN</th>
                            </tr>
                        </thead>
                        <tbody>
